# FetchFaceModels.cmake Downloads YOLOv8-Face and SCRFD ONNX models for face tracking
...
if(NOT EXISTS ${YOLOV8N_FACE_FILE})
  ...
  file(
    DOWNLOAD ${YOLOV8N_FACE_URL} ${YOLOV8N_FACE_FILE}
    SHOW_PROGRESS
...
if(NOT EXISTS ${YOLOV8S_FACE_FILE})
  ...
  file(
    DOWNLOAD ${YOLOV8S_FACE_URL} ${YOLOV8S_FACE_FILE}
    SHOW_PROGRESS
    STATUS DOWNLOAD_STATUS)
  list(GET DOWNLOAD_STATUS 0 STATUS_CODE)
  if(NOT STATUS_CODE EQUAL 0)
